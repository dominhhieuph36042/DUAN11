...
public class TaoTaiKhoanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        daoQuanTriVien = new DAOQuanTriVien(getContext());
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validate(username,name,password,enterPass) > 0) {
                    DAOQuanTriVien thuThuDAO = new DAOQuanTriVien(getContext());
                    if (thuThuDAO.insert(new QuanTriVien(username,name,password)) > 0) {
